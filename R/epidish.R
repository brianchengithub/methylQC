...
# type matches a configurable allowlist (PBMC, WB, WBC, buffy coat, etc.).
#
...
#' @export
run_epidish <- function(betas, reference = NULL, method = NULL, logger = NULL) {
  ...
  ref_data <- get(reference, envir = ref_env)
